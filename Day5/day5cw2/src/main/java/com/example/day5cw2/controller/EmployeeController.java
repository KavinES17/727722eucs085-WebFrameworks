...
public class EmployeeController {
    ...
    public ResponseEntity<Employee> putMethodName(@PathVariable("employeeId") int id, @RequestBody Employee employee) {
    ...
    public ResponseEntity<Employee> delete(@PathVariable("employeeId") int id,@RequestBody Employee employee)
    {
