...
public class LanguageController {
    ...
    public ResponseEntity<Language> getlangauge(@PathVariable("languageId") int id) {
    ...
    public ResponseEntity<Language> putMethodName(@PathVariable int id, @RequestBody Language language) {
    ...
    public ResponseEntity<Language> delete(@PathVariable("languageId") int id)
    {
